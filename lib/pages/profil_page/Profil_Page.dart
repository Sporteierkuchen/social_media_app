  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UserDto?>(
      ...
      builder: (context, snapshot) {
        ...
        String userrole = userData.role ?? "MELKER";
          ...
          SingleChildScrollView(
            child: Column(
              children: [
                ...
                ProfileHeader(
                  userData: userData,
                  videoCountStream: _postRepository.userVideoCountStream(userData.userid!),
                  imageCountStream: _postRepository.userImageCountStream(userData.userid!),
                  videoViewsStream: _postRepository.userVideoViewsStream(userData.userid!),
                  imageViewsStream: _postRepository.userImageViewsStream(userData.userid!),
                  subscribersCountStream: _userRepository.subscribersCountStream(userData.userid!),
                ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MySubscribersSection(
                          userData: userData,
                          subscribersQuery: _userRepository.subscribersQuery(userData.userid!),
                          subscribersCountStream: _userRepository.subscribersCountStream(userData.userid!),
                        ...
                        SubscribedSection(
                          userData: userData,
                          subscribedQuery: _userRepository.subscribedQuery(userData.userid!),
                          subscribersCountStream: _userRepository.subscribedCountStream(userData.userid!),
                          userRepository: _userRepository,
                        ),
